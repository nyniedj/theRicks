 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("Nylah Julmice");
		  toPrint += p1.toString("cjulmice6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Daisha Braxton");
		  toPrint += p2.toString("dbraxton3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Ben Lashley");
		  toPrint += p3.toString("blashley3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Kai Sun");
                  toPrint += p4.toString("ksun68");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Cameron Cacic");
                  toPrint += p5.toString("ccacic3");
